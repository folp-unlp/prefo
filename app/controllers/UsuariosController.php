...
class UsuariosController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				usuarios.Apellido LIKE ? OR 
				usuarios.Nombres LIKE ? OR 
				usuarios.email LIKE ? OR 
				usuarios.Telefono LIKE ? OR 
				usuarios.Rol LIKE ? OR 
				usuarios.Status LIKE ? OR 
				usuarios.Motivo LIKE ? OR 
				usuarios.eSTADO LIKE ?
			)";
	...
	function add($formdata = null){
		if($formdata){
			...
			$tablename = $this->tablename;
			$request = $this->request;
			$fields = $this->fields = ["Usuario","Clave","Apellido","Nombres","email","Telefono","Rol","Status","Motivo","eSTADO"];
	...
	function edit($rec_id = null, $formdata = null){
		...
		$this->rec_id = $rec_id;
		$tablename = $this->tablename;
		$fields = $this->fields = ["idUsuario","Usuario","Clave","Apellido","Nombres","email","Telefono","Rol","Status","Motivo","eSTADO"];
