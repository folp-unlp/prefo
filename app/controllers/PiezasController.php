<?php 
/**
 * Piezas Page Controller
 * @category  Controller
 */
class PiezasController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$this->view->search_template = "piezas/search.php";
		}
		if(!empty($request->orderby)){
			...
			$db->orderBy("piezas.Pieza", ORDER_TYPE);
		}
        if($fieldname){
		...
		$page_title = $this->view->page_title = "Piezas";
		...
		$this->render_view("piezas/list.php", $data); //render the full page
	}
	/**
     * Load csv|json data
     * @return data
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("piezas.Pieza", $rec_id);; //select record based on primary key
		}
		...
		return $this->render_view("piezas/view.php", $record);
	}
	/**
	...
	function add($formdata = null){
        ...
        $this->render_view("piezas/add.php");
	}
	/**
	...
	function edit($rec_id = null, $formdata = null){
		...
		return $this->render_view("piezas/edit.php", $data);
	}
	/**
	...
	function delete($rec_id = null){
		...
		$db->where("piezas.Pieza", $arr_rec_id, "in");
