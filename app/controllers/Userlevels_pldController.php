<?php 
/**
 * Userlevels_pld Page Controller
 * @category  Controller
 */
class Userlevels_pldController extends BaseController{
	function __construct(){
		parent::__construct();
		$this->tablename = "userlevels_pld";
	}
	/**
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				userlevels_pld.userlevelid LIKE ? OR 
				userlevels_pld.userlevelname LIKE ?
			)";
			...
			$this->view->search_template = "userlevels_pld/search.php";
		}
		if(!empty($request->orderby)){
			...
			$db->orderBy("userlevels_pld.userlevelid", ORDER_TYPE);
		}
        if($fieldname){
		...
		$page_title = $this->view->page_title = "Userlevels Pld";
		...
		$this->render_view("userlevels_pld/list.php", $data); //render the full page
	}
	/**
     * Load csv|json data
     * @return data
...
// No View Function Generated Because No Field is Defined as the Primary Key on the Database Table
	...
	function add($formdata = null){
		if($formdata){
			...
			if($this->validated()){
                ...
                if($rec_id) {
                	...
                	return $this->redirect("userlevels_pld");
				} else {
					$this->set_page_error();
				}
			}
        ...
        $this->render_view("userlevels_pld/add.php");
	}
