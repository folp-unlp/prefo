<?php 
/**
 * Userlevelpermissions_pld Page Controller
 * @category  Controller
 */
class Userlevelpermissions_pldController extends BaseController{
	function __construct(){
		parent::__construct();
		$this->tablename = "userlevelpermissions_pld";
	}
	/**
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				userlevelpermissions_pld.userlevelid LIKE ? OR 
				userlevelpermissions_pld.tablename LIKE ? OR 
				userlevelpermissions_pld.permission LIKE ?
			)";
			...
			$this->view->search_template = "userlevelpermissions_pld/search.php";
		}
		if(!empty($request->orderby)){
			...
			$db->orderBy("userlevelpermissions_pld.userlevelid", ORDER_TYPE);
		}
        if($fieldname){
		...
		$page_title = $this->view->page_title = "Userlevelpermissions Pld";
		...
		$this->render_view("userlevelpermissions_pld/list.php", $data); //render the full page
	}
	/**
     * Load csv|json data
     * @return data
	...
	function import_data(){
		...
		$this->redirect("userlevelpermissions_pld");
	}
// No View Function Generated Because No Field is Defined as the Primary Key on the Database Table
	...
	function add($formdata = null){
		if($formdata){
			...
			if($this->validated()){
                ...
                if($rec_id) {
                	...
                	return $this->redirect("userlevelpermissions_pld");
				} else {
					$this->set_page_error();
				}
			}
        ...
        $this->render_view("userlevelpermissions_pld/add.php");
	}
