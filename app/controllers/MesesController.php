<?php 
/**
 * Meses Page Controller
 * @category  Controller
 */
class MesesController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$this->view->search_template = "meses/search.php";
		}
		if(!empty($request->orderby)){
			...
			$db->orderBy("meses.Mes", ORDER_TYPE);
		}
        if($fieldname){
		...
		$page_title = $this->view->page_title = "Meses";
		...
		$this->render_view("meses/list.php", $data); //render the full page
	}
	/**
     * Load csv|json data
     * @return data
...
// No View Function Generated Because No Field is Defined as the Primary Key on the Database Table
	...
	function add($formdata = null){
        ...
        $this->render_view("meses/add.php");
	}
