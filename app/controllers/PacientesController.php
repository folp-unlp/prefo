...
class PacientesController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				pacientes.Documento LIKE ? OR 
				pacientes.IdComision LIKE ? OR 
				pacientes.Apellido LIKE ? OR 
				pacientes.Nombres LIKE ? OR 
				pacientes.Sexo LIKE ? OR 
				pacientes.FechaNacimiento LIKE ? OR 
				pacientes.OS LIKE ? OR 
				pacientes.Residencia LIKE ?
			)";
		...
		$this->render_view("pacientes/list.php", $data); //render the full page
	}
	/**
     * Load csv|json data
     * @return data
	...
	function add($formdata = null){
		if($formdata){
			...
			$tablename = $this->tablename;
			$request = $this->request;
			$fields = $this->fields = ["Documento","IdComision","Apellido","Nombres","Sexo","FechaNacimiento","OS","Residencia"];
			...
			$this->sanitize_array = array(
				...
				'FechaNacimiento' => 'sanitize_string',
				'OS' => 'sanitize_string',
				'Residencia' => 'sanitize_string',
			);
	...
	function edit($rec_id = null, $formdata = null){
		...
		$this->rec_id = $rec_id;
		$tablename = $this->tablename;
		$fields = $this->fields = ["idPaciente","Documento","IdComision","Apellido","Nombres","Sexo","FechaNacimiento","OS","Residencia"];
