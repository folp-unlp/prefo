<?php 
/**
 * Permissionsbkp Page Controller
 * @category  Controller
 */
class PermissionsbkpController extends BaseController{
	function __construct(){
		parent::__construct();
		$this->tablename = "permissionsbkp";
	}
	/**
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				permissionsbkp.userlevelid LIKE ? OR 
				permissionsbkp.tablename LIKE ? OR 
				permissionsbkp.permission LIKE ?
			)";
			...
			$this->view->search_template = "permissionsbkp/search.php";
		}
		if(!empty($request->orderby)){
			...
			$db->orderBy("permissionsbkp.userlevelid", ORDER_TYPE);
		}
        if($fieldname){
		...
		$page_title = $this->view->page_title = "Permissionsbkp";
		...
		$this->render_view("permissionsbkp/list.php", $data); //render the full page
	}
	/**
     * Load csv|json data
     * @return data
...
// No View Function Generated Because No Field is Defined as the Primary Key on the Database Table
	...
	function add($formdata = null){
		if($formdata){
			...
			if($this->validated()){
                ...
                if($rec_id) {
                	...
                	return $this->redirect("permissionsbkp");
				} else {
					$this->set_page_error();
				}
			}
        ...
        $this->render_view("permissionsbkp/add.php");
	}
