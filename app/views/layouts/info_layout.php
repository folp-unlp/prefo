...
<body class="d-flex flex-column h-100">
        ...
        <nav class="navbar navbar-expand-md bg-dark navbar-dark fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="<?php print_link('info/privacy_policy') ?>">Política de privacidad</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" href="<?php print_link('info/terms_and_conditions') ?>">Términos y Condiciones</a>
                    </li>
                    <li class="nav-item active">
    ...
    <footer class="border-top text-dark mt-auto p-3">
