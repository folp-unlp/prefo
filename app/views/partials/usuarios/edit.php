            ...
            <div class="row ">
                <div class="col-md-7">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("usuarios/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <label class="control-label" for="Usuario">Usuario <span class="text-danger">*</span></label>
                                    <div id="ctrl-Usuario-holder" class="">
                                        <input id="ctrl-Usuario"  value="<?php  echo $data['Usuario']; ?>" type="text" placeholder="Ingrese Usuario"  required="" name="Usuario"  class="form-control " />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label" for="Clave">Clave <span class="text-danger">*</span></label>
                                        <div id="ctrl-Clave-holder" class="">
                                            <input id="ctrl-Clave"  value="<?php  echo $data['Clave']; ?>" type="text" placeholder="Ingrese Clave"  required="" name="Clave"  class="form-control " />
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div id="ctrl-email-holder" class="">
                                                        <input id="ctrl-email"  value="<?php  echo $data['email']; ?>" type="email" placeholder="Ingrese Email"  required="" name="email"  class="form-control " />
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label class="control-label" for="Telefono">Telefono <span class="text-danger">*</span></label>
                                                        <div id="ctrl-Telefono-holder" class="">
                                                            <input id="ctrl-Telefono"  value="<?php  echo $data['Telefono']; ?>" type="text" placeholder="Ingrese Telefono"  required="" name="Telefono"  class="form-control " />
                                                            </div>
                                                        </div>
                                                        <div class="form-group ">
                                                            <label class="control-label" for="Rol">Rol <span class="text-danger">*</span></label>
                                                            <div id="ctrl-Rol-holder" class="">
                                                                <input id="ctrl-Rol"  value="<?php  echo $data['Rol']; ?>" type="number" placeholder="Ingrese Rol" step="1"  required="" name="Rol"  class="form-control " />
                                                                </div>
                                                            </div>
                                                            <div class="form-group ">
                                                                <label class="control-label" for="Status">Status <span class="text-danger">*</span></label>
                                                                <div id="ctrl-Status-holder" class="">
                                                                    <input id="ctrl-Status"  value="<?php  echo $data['Status']; ?>" type="number" placeholder="Ingrese Status" step="1"  required="" name="Status"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <label class="control-label" for="Motivo">Motivo <span class="text-danger">*</span></label>
                                                                    <div id="ctrl-Motivo-holder" class="">
                                                                        <textarea placeholder="Ingrese Motivo" id="ctrl-Motivo"  required="" rows="5" name="Motivo" class=" form-control"><?php  echo $data['Motivo']; ?></textarea>
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div id="ctrl-eSTADO-holder" class="">
                                                                        <input id="ctrl-eSTADO"  value="<?php  echo $data['eSTADO']; ?>" type="text" placeholder="Ingrese Estado"  required="" name="eSTADO"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
