            ...
            <div class="row ">
                <div class="col-md-7">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="comision_centrooperativo-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("comision_centrooperativo/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-idCentroOperativo-holder" class="">
                                            <input id="ctrl-idCentroOperativo"  value="<?php  echo $this->set_field_value('idCentroOperativo',""); ?>" type="number" placeholder="Ingrese Idcentrooperativo" step="1"  required="" name="idCentroOperativo"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
