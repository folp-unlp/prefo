                ...
                <div class="col-md-12">
                    ...
                    <div  class="card animated fadeIn page-content">
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-idDiagnostico">
                                        <th class="title"> Iddiagnostico: </th>
                                        <td class="value"> <?php echo $data['idDiagnostico']; ?></td>
                                    </tr>
                                    <tr  class="td-CodigoDiagnostico">
                                        <th class="title"> Codigodiagnostico: </th>
                                        <td class="value"> <?php echo $data['CodigoDiagnostico']; ?></td>
                                    </tr>
                        ...
                        <div class="p-3 d-flex">
                            ...
                            <a class="btn btn-sm btn-warning"  href="<?php print_link("diagnosticos/edit/$rec_id"); ?>">
                                <i class="material-icons">edit</i> Editar
                            </a>
                            <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("diagnosticos/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="¿Seguro quiere borrar este registro?" data-display-style="modal">
