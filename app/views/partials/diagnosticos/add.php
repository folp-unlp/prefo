            ...
            <div class="row ">
                <div class="col-md-7">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="diagnosticos-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("diagnosticos/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div id="ctrl-CodigoDiagnostico-holder" class="">
                                        <input id="ctrl-CodigoDiagnostico"  value="<?php  echo $this->set_field_value('CodigoDiagnostico',""); ?>" type="text" placeholder="Ingrese Codigodiagnostico"  required="" name="CodigoDiagnostico"  class="form-control " />
                                        </div>
                                    </div>
                                    <div class="form-group ">
