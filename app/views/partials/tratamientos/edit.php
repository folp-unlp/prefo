            ...
            <div class="row ">
                <div class="col-md-7">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("tratamientos/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <label class="control-label" for="Codigo">Codigo <span class="text-danger">*</span></label>
                                    <div id="ctrl-Codigo-holder" class="">
                                        <input id="ctrl-Codigo"  value="<?php  echo $data['Codigo']; ?>" type="text" placeholder="Ingrese Codigo"  required="" name="Codigo"  class="form-control " />
                                        </div>
                                    </div>
                                    <div class="form-group ">
