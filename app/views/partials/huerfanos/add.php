            ...
            <div class="row ">
                <div class="col-md-7">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="huerfanos-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("huerfanos/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <label class="control-label" for="iddetalle">Iddetalle <span class="text-danger">*</span></label>
                                    <div id="ctrl-iddetalle-holder" class="">
                                        <input id="ctrl-iddetalle"  value="<?php  echo $this->set_field_value('iddetalle',"0"); ?>" type="number" placeholder="Ingrese Iddetalle" step="1"  required="" name="iddetalle"  class="form-control " />
                                        </div>
                                    </div>
                                    <div class="form-group ">
