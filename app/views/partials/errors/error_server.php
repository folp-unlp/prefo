...
<div class="container">
	...
	<div class="card card-body my-3">
		<p class="lead bold">Póngase en contacto con el Area de Sistemas de la FOLP</p>

		<!-- <div>Tel: <a href="tel:+542214500000" class="bold">221 450-0000</a></div> -->
		<div>Email: <a href="mailto:sistemas@folp.unlp.edu.ar" class="bold">sistemas@folp.unlp.edu.ar</a></div>
	</div>

	<div class="text-center">
		<a href="<?php print_link(HOME_PAGE); ?>" class="btn btn-primary">Volver al inicio</a>
	</div>
</div>