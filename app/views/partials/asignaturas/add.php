            ...
            <div class="row ">
                <div class="col-md-7">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="asignaturas-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("asignaturas/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
