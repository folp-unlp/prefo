...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3 p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col">
                    <h4 class="record-title">Meses</h4>
                </div>
                <div class="col-sm-3">
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("meses/add") ?>">
                        <i class="material-icons">add</i>
                        Agregar nuevo
                    </a>
                </div>
                <div class="col-sm-4">
                    <form  class="search" action="<?php print_link('meses'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 py-2 px-3">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('meses'); ?>">
                                ...
                                <div id="page-report-body" class="table-responsive">
                                    <table class="table table-hover table-striped table-sm text-left table-borderless">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            ?>
                                            <tr>
                                                <td class="td-Mes"> <?php echo $data['Mes']; ?></td>
                                                <td class="td-MesTXt"> <?php echo $data['MesTXt']; ?></td>
                                            </tr>
                                            <?php
                                            }
                                            ?>
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-md-auto justify-content-center">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <?php Html::import_form('meses/import_data' , "Importar datos", 'CSV , JSON'); ?>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <?php
