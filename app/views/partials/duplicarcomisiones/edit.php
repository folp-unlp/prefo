            ...
            <div class="row ">
                <div class="col-md-7">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("duplicarcomisiones/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-CicloLectivo-holder" class="">
                                            <input id="ctrl-CicloLectivo"  value="<?php  echo $data['CicloLectivo']; ?>" type="number" placeholder="Ingrese Ciclolectivo" step="1"  required="" name="CicloLectivo"  class="form-control " />
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <label class="control-label" for="Asignatura">Asignatura <span class="text-danger">*</span></label>
                                            <div id="ctrl-Asignatura-holder" class="">
                                                <input id="ctrl-Asignatura"  value="<?php  echo $data['Asignatura']; ?>" type="number" placeholder="Ingrese Asignatura" step="1"  required="" name="Asignatura"  class="form-control " />
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <label class="control-label" for="Origen">Origen <span class="text-danger">*</span></label>
                                                <div id="ctrl-Origen-holder" class="">
                                                    <input id="ctrl-Origen"  value="<?php  echo $data['Origen']; ?>" type="number" placeholder="Ingrese Origen" step="1"  required="" name="Origen"  class="form-control " />
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label class="control-label" for="Destino1">Destino1 <span class="text-danger">*</span></label>
                                                    <div id="ctrl-Destino1-holder" class="">
                                                        <input id="ctrl-Destino1"  value="<?php  echo $data['Destino1']; ?>" type="number" placeholder="Ingrese Destino1" step="1"  required="" name="Destino1"  class="form-control " />
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label class="control-label" for="Destino2">Destino2 <span class="text-danger">*</span></label>
                                                        <div id="ctrl-Destino2-holder" class="">
                                                            <input id="ctrl-Destino2"  value="<?php  echo $data['Destino2']; ?>" type="number" placeholder="Ingrese Destino2" step="1"  required="" name="Destino2"  class="form-control " />
                                                            </div>
                                                        </div>
                                                        <div class="form-group ">
                                                            <label class="control-label" for="Destino3">Destino3 <span class="text-danger">*</span></label>
                                                            <div id="ctrl-Destino3-holder" class="">
                                                                <input id="ctrl-Destino3"  value="<?php  echo $data['Destino3']; ?>" type="number" placeholder="Ingrese Destino3" step="1"  required="" name="Destino3"  class="form-control " />
                                                                </div>
                                                            </div>
                                                            <div class="form-group ">
                                                                <label class="control-label" for="Destino4">Destino4 <span class="text-danger">*</span></label>
                                                                <div id="ctrl-Destino4-holder" class="">
                                                                    <input id="ctrl-Destino4"  value="<?php  echo $data['Destino4']; ?>" type="number" placeholder="Ingrese Destino4" step="1"  required="" name="Destino4"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <label class="control-label" for="Destino5">Destino5 <span class="text-danger">*</span></label>
                                                                    <div id="ctrl-Destino5-holder" class="">
                                                                        <input id="ctrl-Destino5"  value="<?php  echo $data['Destino5']; ?>" type="number" placeholder="Ingrese Destino5" step="1"  required="" name="Destino5"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
