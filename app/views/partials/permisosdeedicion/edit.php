            ...
            <div class="row ">
                <div class="col-md-7">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("permisosdeedicion/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-PlanillaDocente-holder" class="">
                                            <input id="ctrl-PlanillaDocente"  value="<?php  echo $data['PlanillaDocente']; ?>" type="number" placeholder="Ingrese Planilladocente" step="1"  required="" name="PlanillaDocente"  class="form-control " />
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            ...
                                            <div id="ctrl-PlanillaAsignatura-holder" class="">
                                                <input id="ctrl-PlanillaAsignatura"  value="<?php  echo $data['PlanillaAsignatura']; ?>" type="number" placeholder="Ingrese Planillaasignatura" step="1"  required="" name="PlanillaAsignatura"  class="form-control " />
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                ...
                                                <div id="ctrl-PlanillaComision-holder" class="">
                                                    <input id="ctrl-PlanillaComision"  value="<?php  echo $data['PlanillaComision']; ?>" type="number" placeholder="Ingrese Planillacomision" step="1"  required="" name="PlanillaComision"  class="form-control " />
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div id="ctrl-nueva-holder" class="">
                                                            <input id="ctrl-nueva"  value="<?php  echo $data['nueva']; ?>" type="text" placeholder="Ingrese Nueva"  required="" name="nueva"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
