 ...
 * --------------------------------------------------
 *
 * For PDO support, you need to have the PDO extension installed.
 * http://www.php.net/manual/en/book.pdo.php
 *
 * Forked from https://github.com/tommyknocker/pdo-database-class
 * With some minor changes by Fernando Merlo (ctrbts.dev@gmail.com)
 *
...
class BaseModel
{
    ...
    /**
     * Variable que contiene una cantidad de filas devueltas durante las consultas get/getOne/select con withTotalCount()
     * @var int
     */
    public $totalCount = 0;
    ...
    /**
     * A method to connect to distinct database drivers
     * $dbType ('sqlite', 'mysql', 'pgsql', 'sqlsrv')
     *
     * @throws Exception
     * @return void
     */
     ...
     *
     * @param int|array $numRows Array to define SQL limit in format Array ($count, $offset) or only $count
     * @return void
     */
    ...
    /**
     * Method returns a copy of a BaseModel subquery object
     *
     * @return BaseModel new BaseModel object
     */
     ...
     *
     * @uses $db = BaseModel::getInstance();
     * @return BaseModel Returns the current instance.
     */
     ...
     *
     * @uses $BaseModel->having('SUM(tags) > 10')
     ...
     *
     * @uses $BaseModel->join('table1', 'field1 <> field2', 'LEFT')
     ...
     *
     * @uses $BaseModel->orderBy('id', 'desc')->orderBy('name', 'desc');
     ...
     *
     * @uses $BaseModel->orHaving('SUM(tags) > 10')
     * @param string $havingProp  The name of the database field.
     * @param mixed  $havingValue The value of the database field.
     * @param string $operator Comparison operator. Default is =
     * @return BaseModel
     ...
     *
     * @uses $BaseModel->orWhere('id', 7)->orWhere('title', 'MyTitle');
    ...
    /**
     * Reset BaseModel internal variables
     */
     ...
     *
     * @uses $BaseModel->setQueryOption('name');
    ...
    /**
     * Method creates new BaseModel object for a subquery generation
     *
     ...
     *
     * @uses $BaseModel->where('id', 7)->where('title', 'MyTitle');
     * @param string $whereProp  The name of the database field.
     * @param mixed  $whereValue The value of the database field.
     * @param string $operator Comparison operator. Default is =
