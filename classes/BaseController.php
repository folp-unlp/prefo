 ...
 * Los controladores que no necesiten autenticación de página
 * y autorización a los recursos pueden extenderse de esta clase
 *
...
class BaseController{
	/**
	 * Usado pra chekear si el controlador puede continuar mostrando la página después de la autendticación
	 * @var bool
	 */
	public $status = 200;

	/**
	 * Instancia de la clase BaseView, usada para renderizar las páginas
	 * @var BaseView
	 */
	public $view = null;
	 ...
	 * Provee una capa de acceso a la base de datos
	 * @var BaseModel
	 */
	public $db = null;
	...
	/**
	 * Initialize the base controller. This method sets the database instance and the view instance.
	 */
	...
	function GetModel(){
		...
		$this->db = new BaseModel(DB_TYPE, DB_HOST , DB_USERNAME, DB_PASSWORD, DB_NAME, DB_PORT, DB_CHARSET);
		if($this->soft_delete){
