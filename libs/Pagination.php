...
/**
 * Clase para el paginado de registros devueltos por una consulta.
 * @version 1.0.0
                ...
                if ($numofpages > 1) {
                    ...
                    ?>
                        <div class="<?php echo $list_page_class ?>">
                            <div data-limit-count="<?php echo $limit_count ?>" data-total-records="<?php echo $this->total_records ?>" data-total-page="<?php echo $numofpages ?>" data-range="<?php echo $this->pager_link_range; ?>" class="ajax-pagination"></div>
                        </div>
                    <?php
                    } else {
                    ?>
