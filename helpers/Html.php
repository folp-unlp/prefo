...
?>
     ...
     * NB -- Pass only filename-- (eg. my-plugin.js)
     * @return Html
     */
    public static function page_plugins($arg)
    {
    ?>
        <link rel="stylesheet" href="<?php print_link(PLUGINS_DIR . $arg); ?>" />
    <?php
    }

    /**
     * Link to themes directory
     * NB -- Pass only filename-- (eg. default.css)
     * @return Html
     */
    public static function page_themes($arg)
    {
    ?>
        <link rel="stylesheet" href="<?php print_link(THEMES_DIR . $arg); ?>" />
        <?php
    }
    ...
    public static function captcha_field()
    {
        ...
        <div class="form-group d-flex">
            ...
            <div>
                <input class="form-control" required="" placeholder="ingrese el código" name="form_captcha_code" />
            </div>
        </div>
    <?php
    }
    ...
    public static function page_img($imgsrc, $resizewidth = null, $resizeheight = null, $max = 1, $link = null, $class = null)
    {
        if (!empty($imgsrc)) {
            ...
            foreach ($arrsrc as $src) {
                ...
                $previewattr = null;
                if ($link == null) {
                    $previewlink = "libs/Timthumb.php?src=$src&w=760&h=520";
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <label>Seleccione un archivo para importar <input required="required" class="form-control form-control-sm my-2" type="file" name="file" /></label>
                        <br />
